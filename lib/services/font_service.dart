...
class FontService {
  ...
  static TextTheme getCustomTextTheme(
    ...
    return getFontTheme().copyWith(
      ...
      headlineMedium: getFontTheme().headlineMedium
          ?.copyWith(
            fontSize:
      ...
      titleLarge: getFontTheme().titleLarge?.copyWith(
        fontSize:
            (baseTheme.titleLarge?.fontSize ?? 18) *
            fontScale,
      ),
